...
export type IsEqualFuncType = (data1: any, data2: any, ext: ExtType<any>) => boolean;
...
export type FieldItem<T extends DataTypeBase> = {
    ...
    arrayNeedAlignByLCS?: string | true;
    arrayNeedAlignByCurrentData?: string | true;
    arrayNeedNoAlign?: true;
    labelWidth?: number;
    index?: number;
};
